    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register-moderator') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="select-role" id="select-role" class="form-control">
                                    ...
                                    <option value="Write Moderator">Write Moderator</option>
                                    <option value="Edit Moderator">Edit Moderator</option>
                                    <option value="Publish Moderator">Publish Moderator</option>
                                </select>
                            </div>
                        </div>
